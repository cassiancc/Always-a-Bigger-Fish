...
public class BiggerFishComponentTypes {
    ...
    public static final Supplier<DataComponentType<String>> FISHING_LOOT = registerComponentType("fishing_loot_table",
            (builder) -> builder.persistent(Codec.STRING).networkSynchronized(ByteBufCodecs.STRING_UTF8));

    public static final Supplier<DataComponentType<String>> HOOK_EFFECTS = registerComponentType("hook_effects",
            (builder) -> builder.persistent(Codec.STRING).networkSynchronized(ByteBufCodecs.STRING_UTF8));
