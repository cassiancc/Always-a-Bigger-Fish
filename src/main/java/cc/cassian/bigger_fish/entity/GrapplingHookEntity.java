...
public class GrapplingHookEntity extends Projectile {
    ...
    public void tick() {
        ...
        if (player == null) {
            ...
            if (this.hookedIn != null) {
                ...
                if (hitresult.getType() == HitResult.Type.MISS || !CommonEvents.onProjectileImpact(this, hitresult)) {
    ...
    private boolean shouldStopFishing(Player player) {
        ...
        boolean flag = mainHandRod.is(BiggerFishTags.FISHING_RODS);
        boolean flag1 = offhandRod.is(BiggerFishTags.FISHING_RODS);
    ...
    protected void onHitBlock(BlockHitResult result) {
        ...
        if (player != null){
            ...
            level().playSound(null, soundPosition.x, soundPosition.y, soundPosition.z, BiggerFishSoundEvents.GRAPPLING_HOOK_TIGHTEN, SoundSource.PLAYERS,0.25F, 1);
        }
    }
    ...
    private void updateOwnerInfo(@Nullable GrapplingHookEntity grapplingHook) {
        Player player = this.getPlayerOwner();
        if (player != null) {
            ((PlayerWithGrapplingHook)player).bigger_fish$setHook(grapplingHook);
        }
    }
    ...
    public ItemStack getFishingLine() {
        return getEntityData().get(DATA_HOOK);
    }
    ...
    public EntityType<?> getType() {
        return BiggerFishEntityTypes.GRAPPLING_HOOK;
    }

    @Override
    public Component getName() {
        return Component.translatable("item.bigger_fish.grappling_hook");
    }
