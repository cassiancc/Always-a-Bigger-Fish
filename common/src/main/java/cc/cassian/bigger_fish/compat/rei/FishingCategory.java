...
public class FishingCategory implements DisplayCategory<FishingDisplay> {
    @Override
    public CategoryIdentifier<FishingDisplay> getCategoryIdentifier() {
        return REIClient.FISHING_DISPLAY;
    }
    ...
    public Renderer getIcon() {
        return EntryStacks.of(BiggerFishItems.COPPER_ROD.get());
    }
}
